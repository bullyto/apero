...
function showDgccrfSentPopup() {
  ...
  try {
    if (window.ADN66SentPopup && typeof window.ADN66SentPopup.show === "function") {
      window.ADN66SentPopup.show(title, html);
      return;
    }
  } catch {}
  // fallback (si jamais le HTML n'a pas chargé le popup)
